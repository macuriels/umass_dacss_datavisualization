...
Each key word was searched on a Thursday, filtering only for jobs that were posted in the past week.
...
Below is a snipper of the resulting dataframe, which is also used to render all the plots and insights.
